...
const DRAG_ENTER_CLASS = 'ns-droppable--enter'
 ...
 * @property {String} [enterClass=ns-droppable--enter] 拖拽进入可放置区的元素className
 ...
 *
 *  import droppable from '@modularize/util/directives/ddroppable'
 *  export default {
 *    directives: {
 *      droppable
 *    }
